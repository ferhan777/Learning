...
try {
    ...
    if (!$db->affected_rows) {
        ...
        $check->fetch();
        $check->close();// should close this statement to free up the result
    ...
    $pay->close(); /* in mysqli prep stmt its always good to close the prep stmts after use. understand the concept of buffered and unbuffered query in mysqli*/
    $receive->close();
