<?php
/*
* two ways to avoid sql injection the recommended method is prepared statement and
* pdo quote() method.. example usage is shown in line number 12
* its main disadvantage is, its not supported by all PDO drivers notably ODBC
* slower than the prepared statements
*/
